            ...
            <div className="fixed right-0 top-0 bottom-0 w-full md:w-96 lg:w-[480px] bg-white shadow-2xl z-50 flex flex-col">
                ...
                {cart.length > 0 && (
                    <div className="border-t p-4 lg:p-6 bg-white">
                        ...
                        <button
                            onClick={() => {
                                const newOrder = createOrder(cart); // Save the cart as a new order
                                setShowCart(false);
                                navigate(`/order-success/${newOrder.id}`); // Navigate with the orderId
                            }}
                            className="w-full bg-orange-600 text-white py-3 lg:py-4 rounded-lg font-bold text-base lg:text-lg hover:bg-orange-700 transition-all"
                        >
                            Proceed to Checkout
                        </button>
                    </div>
