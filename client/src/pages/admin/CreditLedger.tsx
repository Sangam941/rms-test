...
const CreditLedger: React.FC = () => {
  ...
  const { customers, getTotalOutstanding, settleDebt } = useCreditStore();
  ...
  const handleSettleDebt = () => {
    if (selectedCustomer && settlementAmount > 0) {
        ...
        <Card className="border-l-4 border-red-500">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">Rs. {totalOutstanding}</p>
            </div>
          </div>
        </Card>
          ...
          <Card key={customer.id} hover onClick={() => navigate(`/admin/customers/${customer.id}`)}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="bg-red-50 rounded-lg p-3">
                ...
                <p className="text-xl font-bold text-red-600">Rs. {customer.totalCredit}</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-3">
                <p className="text-xs text-gray-600 mb-1">Credit Limit</p>
                <p className="text-xl font-bold text-gray-800">Rs. {customer.creditLimit}</p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex justify-between text-xs text-gray-600 mb-1">
                <span>Available: Rs. {customer.creditLimit - customer.totalCredit}</span>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{ width: `${(customer.totalCredit / customer.creditLimit) * 100}%` }}
                />
              </div>
            </div>
            ...
            return (
              <div className="space-y-4">
                <div className="text-center bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-3xl font-bold text-red-600">Rs. {customer.totalCredit}</p>
                </div>
                ...
                {settlementAmount > 0 && (
                  <div className="bg-green-50 rounded-lg p-3">
                    ...
                    <p className="text-xl font-bold text-green-600">
                      Rs. {customer.totalCredit - settlementAmount}
                    </p>
                  </div>
                )}
