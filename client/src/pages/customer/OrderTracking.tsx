...
export const OrderTracking: React.FC = () => {
  ...
  const statusSteps = [
    ...
    { status: 'preparing', label: 'Being Prepared', icon: Utensils, active: ['preparing', 'served', 'completed'].includes(order.status) },
    { status: 'served', label: 'Ready to Serve', icon: Bell, active: ['served', 'completed'].includes(order.status) },
  ];
